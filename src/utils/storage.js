...
export const setUserVCode = value => {
  localStorage.setItem(vcode, value)
}
...
export const setLayoutMune = value => {
  localStorage.setItem(mune, JSON.stringify(value))
}
...
export const setLayoutView = value => {
